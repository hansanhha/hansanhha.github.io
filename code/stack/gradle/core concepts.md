#### index
- [gradle build workflow (simple)](#gradle-build-workflow-simple)
- [gradle build components](#gradle-build-components)
...
위 빌드 과정에 참여하는 구성 요소는 크게 세 가지로 이뤄진다
...
![creating build instances](./assets/creating-build-instances.png)
