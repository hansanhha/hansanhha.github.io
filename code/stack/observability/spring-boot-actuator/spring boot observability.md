...
- [spring boot observability overview](#spring-boot-observability-overview)
...
DefaultMeterObservationHandler: MeberObservationHandler와 Tracer 타입의 스프링 빈이 등록되지 않은 경우 counter와 timer를 측정하는 DefaultMeterObservationHandler를 등록한다
