...
- [micrometer tracing dependencies](#micrometer-tracing-dependencies)
- [tracing terminology](#tracing-terminology)
- [micrometer tracing components and workflow](#micrometer-tracing-components-and-workflow)
...
2. order service에서 새로운 span을 생성한다
...
## micrometer tracing components and workflow
